pipeline {
    ...
    environment {
        ...
        IMAGE_TAG = 'latest'
        RESOURCE_GROUP = 'myResourceGroup8414'
        AKS_CLUSTER = 'myAKSCluster8414'
        TF_WORKING_DIR = '.'
    }
    ...
    stages {
        stage('Checkout') {
            steps {
                git branch: 'main', url: 'https://github.com/Abhinunia2005/Jenkins-Docker-Kubernetes-Terraform.git'
            }
        }
